...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__get15_1__ = __webpack_require__(7);
...
var links = [
    {
        link: '/queens',
        text: 'Queens',
        component: __WEBPACK_IMPORTED_MODULE_6__queens__["a" /* default */]
    }, /*{
        link: '/15',
        text: '15',
        ...
        link: '/15',
        text: '15',
        component: __WEBPACK_IMPORTED_MODULE_2__get15_2__["a" /* default */]
    },{
        link: '/set',
        text: 'Set',
        component: __WEBPACK_IMPORTED_MODULE_3__set__["a" /* default */]
    }, {
        link: '/todo',
        text: 'Todo',
        component: __WEBPACK_IMPORTED_MODULE_5__todo__["a" /* default */]
    }, {
        link: '/blackbox',
        text: 'Blackbox',
        component: __WEBPACK_IMPORTED_MODULE_7__blackbox__["a" /* default */]
    }
];

class Router {
    oncreate(vnode) {
        __WEBPACK_IMPORTED_MODULE_0_mithril___default.a.route(vnode.dom, '/queens',
...
class Navbar {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()("nav.navbar.navbar-default",
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()(".container-fluid",
                __WEBPACK_IMPORTED_MODULE_0_mithril___default()(".navbar-header",
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()("ul.nav.navbar-nav", [
                        links.map(link =>
                            __WEBPACK_IMPORTED_MODULE_0_mithril___default()("li",
                                __WEBPACK_IMPORTED_MODULE_0_mithril___default()("a[href=#!" + link.link + "]",
                                    link.text
                                ))
                        )
                    ])
...
__WEBPACK_IMPORTED_MODULE_0_mithril___default.a.mount(document.body, { view: vnode => [__WEBPACK_IMPORTED_MODULE_0_mithril___default()(Navbar), __WEBPACK_IMPORTED_MODULE_0_mithril___default()(Router)] });
...
var permut = a => {
    ...
    a.forEach((e, idx) => {
        ...
        c.splice(idx, 1);
        var r = permut(c);
        r.forEach(el => result.push(__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.flatten([e, el])));
    });
    return result;
};
...
var solve_ = (numbers) => {
    ...
    closest = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.sortBy(closest, 'diff');
...
class DiceInput {
    ...
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('table', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('tr',
            __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.map(this.numbers, n => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('td', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button', {
                style: (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(inputs, i => i.key === vnode.attrs.key).number === n) ?
...
var setInput = inputNumber => selectedNumber => () => {
    __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(inputs, i => i.key === inputNumber).number = selectedNumber;
    solve(__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.pluck(inputs, 'number'));
};
...
class Router {
    view(vnode) {
        return [
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', '15-15-15-15'),
            __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.map(inputs, i => [
                __WEBPACK_IMPORTED_MODULE_0_mithril___default()(DiceInput, {
                    key: i.key,
                    number: i.number,
                    onchange: setInput(i.key)
                })
            ]),
            simplesolution.map(solution => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('pre', solution)),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr'),
            __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.first(closest,30).map(solution => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('pre', JSON.stringify(solution.diff) + ': ' + JSON.stringify(solution.text)))
        ];
    }
}
...
var special_permut = a => {
    ...
    a.forEach((e, idx) => {
        let c = a.slice();
        c.splice(idx, 1);
        result.push(__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.flatten([e, c]));
    });
    return result;
};
...
class DiceInput {
    ...
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('table', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('tr',
            __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.map(this.numbers, n => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('td', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-default', {
                style: (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.find(inputs, i => i.key === vnode.attrs.key).number === n) ?
                    'background-color:red' : '',
                onclick: vnode.attrs.onchange(n)
            },
...
class BiFuncView {
    view(vnode) {
        return [__WEBPACK_IMPORTED_MODULE_0_mithril___default()('input[type=checkbox]', {
...
console.log('underscore first', __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.first([],39));

class Router {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.container', [
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', '15-15-15-15'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h3', 'binary'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.row', [
                binaryFunctions.map(bifn => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.col-md-2.col-xs-2', __WEBPACK_IMPORTED_MODULE_0_mithril___default()(BiFuncView, { fn: bifn }))),
            ]),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h3', 'unary'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.row', [
                unaryFunctions.map(bifn => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.col-md-2.col-xs-2', __WEBPACK_IMPORTED_MODULE_0_mithril___default()(BiFuncView, { fn: bifn })))
            ]),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h3', 'Dice'),
            __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.map(inputs, i => [
                __WEBPACK_IMPORTED_MODULE_0_mithril___default()(DiceInput, {
                    key: i.key,
                    number: i.number,
            ...
            simplesolution.map(solution => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('pre', solution)),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr'),	    
            __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.first(closest, 30)?__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.first(closest, 30).map(solution => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('pre', JSON.stringify(solution.diff) + ': ' + JSON.stringify(solution.text))):null
        ]);
    }
}
...
var isSet = (k1, k2, k3) => {
    if (!(k1 && k2 && k3))
        return false;
    for (let p in k1) {
        if (!setCondition(...__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.pluck([k1, k2, k3], p)))
            return false;
    }
    return true;
};
...
var select = (karte) => () => {
    if (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.contains(selectedKarten, karte)) {
        selectedKarten = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.filter(selectedKarten, (karteInSet) => !equal(karteInSet, karte));
    } else {
...
class Karte {
    view(vnode) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.col-md-1.col-xs-1' + (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.contains(selectedKarten, vnode.attrs.karte) ? '.debug' : ''), {
            style: 'height:120px;width:50px',
            onclick: select(vnode.attrs.karte)
        },
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.muster' + vnode.attrs.karte.muster + '.form' + vnode.attrs.karte.form, {
...
var removeSet = (set) => () => {
    aufDemTisch = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.filter(aufDemTisch, e => !__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.contains(set, e));
    checkForSet();
}
...
class Router {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.container', [
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'Tisch ' + aufDemTisch.length),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-primary', { onclick: e => drawKart() }, 'Zieh'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-success', { onclick: set1 }, 'Set Spieler 1'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-success', { onclick: set2 }, 'Set Spieler 2'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.row', [
                aufDemTisch.map(k => __WEBPACK_IMPORTED_MODULE_0_mithril___default()(Karte, { karte: k }))
            ]),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'Sets auf dem Tisch: ' + sets.length+' ', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-primary', { onclick: () => collapsed1 = !collapsed1 }, 'Zeigen')),
            collapsed1 ? null : sets.map(set => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.row', [set.map(k => __WEBPACK_IMPORTED_MODULE_0_mithril___default()(Karte, { karte: k })), __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-danger', { onclick: removeSet(set) }, '«'), __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr')])),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'Sets Player 1: ' + setsOfPlayer1.length+' ', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-primary', { onclick: () => collapsed2 = !collapsed2 }, 'Zeigen')),
            collapsed2 ? null : setsOfPlayer1.map(set => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.row', [set.map(k => __WEBPACK_IMPORTED_MODULE_0_mithril___default()(Karte, { karte: k })), __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr')])),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'Sets Player 2: ' + setsOfPlayer2.length+' ', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('button.btn.btn-primary', { onclick: () => collapsed3 = !collapsed3 }, 'Zeigen')),
            collapsed3 ? null : setsOfPlayer2.map(set => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.row', [set.map(k => __WEBPACK_IMPORTED_MODULE_0_mithril___default()(Karte, { karte: k })), __WEBPACK_IMPORTED_MODULE_0_mithril___default()('hr')]))
        ]);
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = Router;
...
var countCardsInSets = (sets) => {
    ...
    sets.forEach(set => {
        set.forEach(card => {
            ...
            if (!__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.has(map, key)) {
                map[key] = {
                    count: 0,
                    card: card
                };
...
for (let k = 0; k < 50; k++) {
    ...
    while (true) {
        ...
        sorted = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.sortBy(cardCountInSet, 'count');
        var idx = Math.floor(Math.random() * sorted.length);
        aufDemTisch = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.filter(aufDemTisch, card => {
...
class SetFragment {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'SetFragment')
    }
}
/* unused harmony export default */
...
class TodoItemView {
    view(vnode) {
        return [
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()(".input-group",
                [
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()("span.input-group-addon",
                        __WEBPACK_IMPORTED_MODULE_0_mithril___default()("input[aria-label='...'][type='checkbox']", {
                            checked: vnode.attrs.todo.getCompleted(),
                            onchange: ev => { console.log(ev); vnode.attrs.todo.setCompleted(ev.target.checked) }
                        })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()("input.form-control[aria-label='...'][type='text']", { value: vnode.attrs.todo.description }),
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()(".input-group-btn",
                        [
                            __WEBPACK_IMPORTED_MODULE_0_mithril___default()("button.btn.btn-default[aria-label='Help'][type='button']",{
                                onclick: ev=>todoList.removeTodo(vnode.attrs.todo)
                            },
                                __WEBPACK_IMPORTED_MODULE_0_mithril___default()("span.glyphicon.glyphicon-remove")
                            ),
                        ]
                    )
                ]
...
class TodoListView {
    ...
    view(vnode) {
        return [
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()(".input-group",
                [
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()("input.form-control[placeholder='Search for...'][type='text']", {
                        onchange: (ev) => {
                            this.description = ev.target.value;
                        }
                    }),
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()("span.input-group-btn",
                        __WEBPACK_IMPORTED_MODULE_0_mithril___default()("button.btn.btn-default[type='button']", {
                            onclick: (ev) => {
            ...
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.list-group',
                vnode.attrs.todoList.getTodos().map(todo =>
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()(TodoItemView, { todo: todo })
                )
            )
        ];
    }
...
class TodoApp {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.container', [
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'todos'),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()(TodoListView, { todoList })
        ]);
    }
}
...
class SolutionView {
    view(vnode) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('table', range(0, size_).
            map(row => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('tr', range(0, size_).
                map(column => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('td', {
...
class Comp {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.container', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'Queens ' + size_ + 'x' + size_ + ' has ' + solutions.length + ' solutions'),
            ...
            , __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.row', [
                solutions.map(solution => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.col-md-4.col-xs-12', { style: 'margin-bottom:40px' }, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(SolutionView, { solution, size: 30 })))
            ]))
    }
}
...
const Field = () => {
    ...
    let placeBallRec = (balls_, count) => {
        ...
        return (count === 0) ? balls_ : balls_.
            ...
            length > 0 ? placeBallRec(balls_, count) : placeBallRec(__WEBPACK_IMPORTED_MODULE_1__fn__["a" /* default */].flatten([balls_, ball]), count - 1);
    };
    const hasBall = (ball) => !__WEBPACK_IMPORTED_MODULE_1__fn__["a" /* default */].isEmpty(balls.filter(ball.equal));
...
class HintView {
    ...
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('td.bb-hint', {
            onclick: e => {
...
class SlotView {
    view(vnode) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('td.bb' + (guessField.hasBall(p) ? '.bb-guess' : ''), {
...
class ColumnView {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('td.bb-empty', vnode.attrs, vnode.children);
    }
}

class RowView {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('tr', vnode.attrs, vnode.children);
    }
}
...
class FieldView {
    view(vnode) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('table',
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()(RowView, [
                __WEBPACK_IMPORTED_MODULE_0_mithril___default()(ColumnView),
                __WEBPACK_IMPORTED_MODULE_1__fn__["a" /* default */].range(0, size).map(i =>
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()(ColumnView,
                        __WEBPACK_IMPORTED_MODULE_0_mithril___default()(HintView, {
            ...
            __WEBPACK_IMPORTED_MODULE_1__fn__["a" /* default */].range(0, size).map((rowNumber) =>
                __WEBPACK_IMPORTED_MODULE_0_mithril___default()(RowView, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(ColumnView, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(HintView, {
                    start: { row: rowNumber, column: -1 },
                    direction: Directions.leftToRight
                })),
                __WEBPACK_IMPORTED_MODULE_1__fn__["a" /* default */].range(0, size).map(column =>
                        __WEBPACK_IMPORTED_MODULE_0_mithril___default()(ColumnView, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(SlotView, { row:rowNumber,column }))
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_mithril___default()(ColumnView, __WEBPACK_IMPORTED_MODULE_0_mithril___default()(HintView, {
...
class Comp {
    view(vnode) {
        return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.container', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('h1', 'Blackbox ' + field.getSize() + 'x' + field.getSize()
        ),
            __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.form-group', __WEBPACK_IMPORTED_MODULE_0_mithril___default()('input', { type: 'range', min: 4, max: 8, onchange: (ev) => setSize(ev.target.valueAsNumber) }))
            , __WEBPACK_IMPORTED_MODULE_0_mithril___default()(FieldView, { field, size: 30 }))
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = Comp;
